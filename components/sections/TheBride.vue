<template>
  <div>
    <section
      class="min-h-screen bg-[url(/img/wiwit.webp)] bg-cover bg-center bg-no-repeat shadow-[inset_0_0_0_2000px_rgba(0,0,0,0.5)] text-primary-white flex flex-col items-start justify-end"
    >
      <!-- Content -->
